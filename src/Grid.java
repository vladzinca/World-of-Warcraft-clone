...
public class Grid extends ArrayList<ArrayList<String>> {
    ...
    static Grid generateMap(int length, int width) {
        ...
        while ((finishLength == shop1Length && finishWidth == shop1Width) || (finishLength == shop2Length && finishWidth == shop2Width) || (finishLength == enemy1Length && finishWidth == enemy1Width) || (finishLength == enemy2Length && finishWidth == enemy2Width) || (finishLength == enemy3Length && finishWidth == enemy3Width) || (finishLength == enemy4Length && finishWidth == enemy4Width)) {
