public class MageTest {
    public static void main(String[] args) {
        ...
        System.out.println("Caracterul " + mage.name + " este de tip mage si se afla la pozitia (" + mage.ox + ", " +
                mage.oy + ")");
        ...
        System.out.println("El are experienta " + mage.currentExperience + " care il duce la nivelul " +
                mage.currentLevel);
        System.out.println("Acestea il fac sa aiba strength " + mage.strength + ", charisma " + mage.charisma +
                " si dexterity " + mage.dexterity);
        Enemy enemy = new Enemy();
        Spell spell = new Ice();
        System.out.println("Ii creem un inamic cu health " + enemy.health);
        System.out.println("Folosind abilitatea de gheata, " + mage.name + " il ataca pe inamic, dandu-i damage " +
                mage.getDamage(spell));
        ...
        System.out.println("Acum caracterul are o potiune in inventar cu pretul " +
                mage.inventory.potions.get(0).getPrice() + ", valoarea de regenerare " +
                mage.inventory.potions.get(0).getRegenValue() + " si care cantareste " +
                mage.inventory.potions.get(0).getWeight());
