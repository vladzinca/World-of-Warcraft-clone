public class RogueTest {
    public static void main(String[] args) {
        ...
        System.out.println("Caracterul " + rogue.name + " este de tip rogue si se afla la pozitia (" + rogue.ox + ", " +
                rogue.oy + ")");
        ...
        System.out.println("El are experienta " + rogue.currentExperience + " care il duce la nivelul " +
                rogue.currentLevel);
        System.out.println("Acestea il fac sa aiba strength " + rogue.strength + ", charisma " + rogue.charisma +
                " si dexterity " + rogue.dexterity);
        Enemy enemy = new Enemy();
        Spell spell = new Earth();
        System.out.println("Ii creem un inamic cu health " + enemy.health);
        System.out.println("Folosind abilitatea de pamant, " + rogue.name + " il ataca pe inamic, dandu-i damage " +
                rogue.getDamage(spell));
        ...
        System.out.println("Acum caracterul are o potiune in inventar cu pretul " +
                rogue.inventory.potions.get(0).getPrice() + ", valoarea de regenerare " +
                rogue.inventory.potions.get(0).getRegenValue() + " si care cantareste " +
                rogue.inventory.potions.get(0).getWeight());
