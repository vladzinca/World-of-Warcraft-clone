...
public class InventoryTest {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < inventory.potions.size(); i++)
            System.out.println("Potiunea " + inventory.potions.get(i).getType() + " are pretul " +
                    inventory.potions.get(i).getPrice() + ", valoarea de regenerare " +
                    inventory.potions.get(i).getRegenValue() + " si cantareste " +
                    inventory.potions.get(i).getWeight());
        System.out.println();
        ...
        for (int i = 0; i < inventory.potions.size(); i++)
            System.out.println("Potiunea " + inventory.potions.get(i).getType() + " are pretul " +
                    ...
                    inventory.potions.get(i).getWeight());
        System.out.println();
        System.out.println("Calculand greutatea disponibila, libera a inventarului, aflam ca este: " +
